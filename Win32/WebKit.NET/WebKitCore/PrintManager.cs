...
namespace WebKit
{
    internal class PrintManager
    {
        ...
        private void _document_PrintPage(object sender, PrintPageEventArgs e)
        {
            ...
            _RemotableHandle _rh = new _RemotableHandle();
            _rh.fContext = NativeMethods.WDT_INPROC_CALL;
            _rh.u.hInproc = _hDC;
            ...
            if (_printGfx == null)
            {
                ...
                _ownerInvoke(() => _webFramePrivate.setInPrintingMode(1, ref _rh));

                _nPages = _ownerInvoke(() =>
                {
                    return _webFramePrivate.getPrintedPageCount(ref _rh);
                });

                _page = 1;
            }

            _ownerInvoke(() => _webFramePrivate.spoolPages(ref _rh, _page, _page, IntPtr.Zero));
            ...
            {
                _ownerInvoke(() => _webFramePrivate.setInPrintingMode(0, ref _rh));
